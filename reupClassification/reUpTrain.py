...
from reupClassification.QNNRepo.QNNLib import dev, enc_func
from reupClassification.QNNRepo.QNNLibs import type2MC
...
# data
DS_TYPE = 'basic'
BATCH_SIZE = 6 #32(small) 6(Small30) 3(verySmall) small60/small60_xhalf(12)
#* model
...
recordId = f"reUp_{saveDate}_{DS_TYPE}_{midcir.name}_{NUM_LAYERS}L_{OPTIMIZER}{STEP_SIZE}_sg{LAMBDA}{TYPE_SGW}"
